...
- Current verification baseline: latest known full suite `pytest: 377 passed`, latest targeted document-discard regression slice `59 passed`, latest targeted knowledge query/API slice `45 passed`, `alembic: 0047_knowledge_index_metadata (head)`, `npm --prefix frontend run build` passed.
