...
- Jelenlegi preferált chat-modell load profil: `context_length=30720`, `eval_batch_size=6144`, `flash_attention=true`, `offload_kv_cache_to_gpu=true`.
- Embedding modell betöltésnél a jelenlegi profil `context_length=12288`, és az LM Studio miatt nem küldjük az `eval_batch_size`, `flash_attention`, illetve `offload_kv_cache_to_gpu` mezőket.
