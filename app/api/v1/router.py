...
from app.api.v1.document_collections import router as document_collections_router
...
api_router.include_router(document_collections_router, tags=["document-collections"])
