...
class Settings:
    ...
    llm_auto_load_embedding_model: bool
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        llm_embedding_context_length=int(_getenv("BOBERDETECTIVE_LLM_EMBEDDING_CONTEXT_LENGTH", "8192")),
        ...
        llm_auto_load_embedding_model=_getenv_bool("BOBERDETECTIVE_LLM_AUTO_LOAD_EMBEDDING_MODEL", True),
        embedding_batch_size=int(_getenv("BOBERDETECTIVE_EMBEDDING_BATCH_SIZE", "8")),
        ...
        qdrant_url=_getenv("BOBERDETECTIVE_QDRANT_URL", "http://127.0.0.1:6333"),
        qdrant_chunk_collection=_getenv("BOBERDETECTIVE_QDRANT_CHUNK_COLLECTION", "boberdetective_chunks"),
    )
