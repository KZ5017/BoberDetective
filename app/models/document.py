...
class DocumentModel(Base):
    ...
    document_group_code: Mapped[str] = mapped_column(Text, nullable=False, default="uncategorized")
    document_type_code: Mapped[str] = mapped_column(Text, nullable=False, default="uncategorized")
