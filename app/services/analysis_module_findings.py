...
def build_search_findings_user_prompt(
    ...
    return (
        ...
        "- If the QUERY explicitly names or clearly describes a concrete focus item, and the SOURCE directly contains that same item together with a factual statement, role, attribute, action, location, date/time, amount, relationship, status, reference, or observation about it, treat it as direct information about the QUERY focus.\n"
        "- Concrete focus items may include persons, organizations, locations, phone numbers, email addresses, license plates, money amounts, case references, document references, attachments.\n"
